        ...
        <div class="content-bottom-inner">
            <ul>
   	      ...
   	      <h4>Admin Services</h4></li>
                ...
                <li>Administrator menas a super user to the System,In this Admin has a right to access all the Student profiles, can check the appointments and grant the Registration requests. </li>
            ...
            <ul>
                ...
                <li>Registered Students can access all the Services like seeting tasks, goals and scheduling appointments and have an access to check the access points in a building, nearest parking spots and Shettle bus schedules. </li>
            ...
            <ul class="lastcol">
       	    <li><h4>Success Stories</h4></li>
                <li><img src="images/3.jpg" alt="image3" width="270" /></li>
                 <li>This, brings you to read the the some of the Success stories of the students who have a disability and how they achieved their goals..... </li>
